...
use crate::{
    ...
    provider::{
        ...
        types::{
            ApiProtocol, AssistantContent, AssistantMessage, ContextMessage, ProviderContextAnchor,
            ProviderContextFragment, ProviderContextPayload, ProviderOrigin, ProviderOutput,
