 ...
 * Keep its revision requirement in a small, fixture-testable validator so a
...
export function hasExactOpenMessageWireShape(value: unknown): boolean {
  return (
    ...
    Object.keys(value).sort().join("\0") ===
      "attachments\0author\0client_nonce\0content\0created_at\0deleted\0edited_at\0mentions\0message_id\0place\0reactions\0reply_to\0revision\0seq\0urgency" &&
