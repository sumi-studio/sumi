...
func TestUserCommandIngress_RequiresOneExactInstallationScope(t *testing.T) {
	for _, testCase := range []struct {
		...
		{name: "malformed installation", query: "?installation_id=not-a-uuid&authority_epoch=1"},
		{name: "wrong-version installation", query: "?installation_id=018f47a2-9b3c-4def-8abc-0123456789ab&authority_epoch=1"},
		{name: "wrong-variant installation", query: "?installation_id=018f47a2-9b3c-7def-0abc-0123456789ab&authority_epoch=1"},
