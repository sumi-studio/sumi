...
DROP TABLE IF EXISTS workspace_role_app_capability_grants;
DROP TRIGGER IF EXISTS app_workspace_role_capability_identity_immutable
    ON app_workspace_role_capabilities;
DROP FUNCTION IF EXISTS prevent_app_workspace_role_capability_identity_mutation();
DROP TABLE IF EXISTS app_workspace_role_capabilities;
...
DROP TRIGGER IF EXISTS workspace_owner_valid ON workspaces;
DROP FUNCTION IF EXISTS validate_workspace_owner_change();
